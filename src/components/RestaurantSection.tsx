...
const RestaurantSection: React.FC = () => (
  <section id="restaurants" className="py-24 bg-transparent overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-16">
        ...
        >
          ...
          <div className="absolute -top-6 -right-6 bg-white p-5 rounded-2xl shadow-xl max-w-[200px] border border-gray-100 animate-float">
            ...
            <div className="text-xs text-green-600 bg-green-50 inline-block px-2 py-1 rounded-full font-medium">ce mois-ci</div>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            Devenons partenaires de votre{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-red-600">succès</span>
          </motion.h2>

          <motion.p variants={fadeUp} className="text-lg text-gray-600 mb-8">
            Ne laissez plus vos tables vides. Notre plateforme connecte votre savoir-faire
            culinaire à une communauté locale affamée et fidèle.
          </motion.p>
