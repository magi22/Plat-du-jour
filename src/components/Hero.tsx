      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left z-20">
            ...
            >
              ...
              <span className="text-primary relative inline-block">
                ...
                {/* Bande jaune */}
                <svg
                  className="absolute w-full h-4 -bottom-2 left-0 text-yellow-300 -z-10"
                  viewBox="0 0 100 10"
            ...
            >
              Fini l&apos;indécision du midi. Découvrez les menus du jour en temps réel et réservez votre table en un clin
              d&apos;œil.
            </p>
          ...
          <div className="w-full lg:w-1/2 relative perspective-1000 z-10 mt-10 lg:mt-0">
            ...
            {/* Float Right Mid */}
            <div
              className="absolute top-32 -right-6 md:-right-12 bg-white p-3 rounded-2xl shadow-xl flex items-center gap-3 animate-float z-20"
