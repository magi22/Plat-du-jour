    ...
    plans: {
      user: {
        ...
        premium: {
          ...
          pricing: {
            monthly: ['4.99€', '/mois'],
            yearly: ['49.90€', '/an', 'Économisez 2 mois'],
          },
      ...
      restaurant: {
        ...
        premium: {
          ...
          pricing: {
            monthly: ['49€', '/mois'],
            yearly: ['490€', '/an', 'Économisez 2 mois'],
          },
    ...
    plans: {
      user: {
        ...
        premium: {
          ...
          pricing: {
            monthly: ['€4.99', '/month'],
            yearly: ['€49.90', '/year', 'Save 2 months'],
          },
          cta: 'Go Premium',
        },
      },
    ...
    plans: {
      user: {
        ...
        premium: {
          ...
          pricing: {
            monthly: ['4.99€', '/Monat'],
            yearly: ['49.90€', '/Jahr', '2 Monate sparen'],
          },
          cta: 'Premium werden',
        },
      },
      restaurant: {
        ...
        premium: {
          ...
          pricing: {
            monthly: ['49€', '/Monat'],
            yearly: ['490€', '/Jahr', '2 Monate sparen'],
          },
    ...
    plans: {
      user: {
        ...
        premium: {
          ...
          pricing: {
            monthly: ['4.99€', '/mese'],
            yearly: ['49.90€', '/anno', 'Risparmia 2 mesi'],
          },
          cta: 'Passa a Premium',
        },
      },
      restaurant: {
        ...
        premium: {
          ...
          pricing: {
            monthly: ['49€', '/mese'],
            yearly: ['490€', '/anno', 'Risparmia 2 mesi'],
          },
