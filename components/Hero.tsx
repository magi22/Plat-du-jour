...
const Hero: React.FC = () => {
  return (
    <section className="relative pt-32 pb-24 lg:pt-48 lg:pb-32 overflow-visible bg-gradient-to-br from-orange-50 via-white to-orange-100">
      ...
      <div className="absolute top-20 right-0 -mr-20 w-96 h-96 bg-orange-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float"></div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left z-20">
            ...
            <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-white border border-orange-100 shadow-lg shadow-orange-100/50 text-primary font-bold text-sm mb-8 animate-pop-in hover:scale-105 transition-transform cursor-default">
              <img src="https://cdn-icons-png.flaticon.com/512/3461/3461980.png" alt="Mascotte" className="w-8 h-8 animate-bounce" />
              <span>Gaston a faim ! Et vous ?</span>
            </div>

            <h1 className="text-5xl lg:text-7xl font-black text-gray-900 leading-[1.1] mb-8 opacity-0 animate-slide-up" style={{ animationDelay: '0.1s' }}>
              Le <span className="text-primary relative inline-block">
                Plat du Jour
              ...
              </span> <br/> juste à côté.
            </h1>
            <p className="text-xl text-gray-600 mb-10 leading-relaxed max-w-lg mx-auto lg:mx-0 opacity-0 animate-slide-up" style={{ animationDelay: '0.2s' }}>
              Fini l'indécision du midi. Découvrez les menus du jour en temps réel et réservez votre table en un clin d'œil.
            </p>
            
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 opacity-0 animate-slide-up" style={{ animationDelay: '0.3s' }}>
              <a 
              ...
              >
                <Apple size={32} className="fill-current group-hover:rotate-12 transition-transform" />
                <div className="text-left">
                  <div className="text-xs font-medium opacity-80 uppercase tracking-wider">Télécharger sur</div>
              ...
              >
                <div className="relative">
                    <Play size={28} className="fill-current ml-1 group-hover:text-green-600 transition-colors" />
                </div>
                <div className="text-left">
                  <div className="text-xs font-medium opacity-80 uppercase tracking-wider">Disponible sur</div>
          ...
          <div className="w-full lg:w-1/2 relative perspective-1000 z-10 mt-10 lg:mt-0">
            ...
            <div className="relative mx-auto w-[320px] h-[640px] bg-gray-900 rounded-[3.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)] border-[12px] border-gray-900 transform rotate-y-12 rotate-x-6 hover:rotate-y-0 hover:rotate-x-0 transition-transform duration-700 ease-out z-10">
               ...
               <div className="absolute top-24 -left-[16px] h-10 w-[4px] bg-gray-800 rounded-l-md"></div>
               <div className="absolute top-36 -left-[16px] h-16 w-[4px] bg-gray-800 rounded-l-md"></div>
               <div className="absolute top-28 -right-[16px] h-20 w-[4px] bg-gray-800 rounded-r-md"></div>
               ...
               <div className="absolute inset-0 bg-white rounded-[2.8rem] overflow-hidden">
                 ...
                 {/* Full Screen Food Image - Plat Suisse (Viande & Légumes) */}
                 <div className="w-full h-full relative">
                    <img 
                        ...
                        alt="Plat Suisse Viande et Légumes"
                    />
                 ...
                 <div className="absolute bottom-0 w-full p-6 z-30">
                    <div className="bg-white/95 backdrop-blur-xl rounded-3xl p-5 shadow-2xl animate-slide-up">
                        <div className="flex justify-between items-start mb-2">
                            ...
                            <span className="bg-primary text-white px-3 py-1 rounded-full text-sm font-bold shadow-lg shadow-orange-500/40">
                                -20%
                            </span>
                        </div>
            ...
            {/* Popping Food Element (3D Overlay) */}
            ...
            <div className="absolute bottom-40 -left-10 bg-white p-4 rounded-2xl shadow-xl flex items-center gap-3 animate-float z-30 max-w-[180px]">
                ...
                <div>
                    <p className="font-bold text-sm text-gray-800">Cuisine Fraîche</p>
                    <p className="text-[10px] text-gray-500">Produits locaux</p>
                </div>
            </div>

            {/* Pop 2: Right Top/Middle (New) */}
            <div className="absolute top-32 -right-6 md:-right-12 bg-white p-3 rounded-2xl shadow-xl flex items-center gap-3 animate-float z-20" style={{ animationDelay: '2s' }}>
                ...
                <div>
                    <p className="font-bold text-sm text-gray-800">Prêt en 20 min</p>
                    <p className="text-[10px] text-gray-500">Service rapide</p>
                </div>
            </div>
